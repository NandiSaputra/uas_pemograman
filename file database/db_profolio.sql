...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Agu 2021 pada 00.43
...
(2, '1999-06-11', 'Cireobn', '081993520678', 22, 'Sepak Bola', 'Mahasiswa');
...
(18, 'Sujono', 'enda@gmail.com', 'Pelaporan', 'Jadwal belum benar');
...
(1, 'Kasir', '2017-2018', 'PT.INDOMARCO PRISMATAMA(INDOMARET)');
...
--
-- Dumping data untuk tabel `pekerjaan2`
--

INSERT INTO `pekerjaan2` (`id_pekerjaan2`, `nama_pekerjaan`, `lama_kerja`, `nama_perusahaan`) VALUES
(1, 'Mekanik Sepeda Motor', '2019-2020', 'NAGA MAS MOTOR CIREBON');
...
(1, 'SDN 2 MAYUNG', 'Desa Mayung, Kec. Gunung Jati, Kab. Cierbon', 2006, 2012);
...
(2, 'SMKN 1 GUNUG JATI', 'Desa.Babadan , Kec.Gunung Jati , Kab.Cirebon', 'TEKNIK SEPEDA MOTOR ', 2015, 2018);
...
(2, 'SMPN 3 GUNUNG JATI', 'Desa.Sambeng, Kec.Gunung Jati, Kab.Cirebon', 2012, 2015);
...
(1, 'UNIVERSITAS CATUR INSAN CENDEKIA', 'JL.Kesambi No.202, Derajat, Kec.Kesambi, Kota.Cirebon', 'SISTEM INFORMASI 2', 2019, 'masih Kuliah');
...
(1, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'Nandi Saputra', 'nandysyahputra59@gmail.com');
